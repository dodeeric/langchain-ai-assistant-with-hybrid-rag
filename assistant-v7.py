...
def instanciate_retrievers_and_chains(_vector_db):
    ...
    vector_retriever = vector_db.as_retriever(search_type="similarity", search_kwargs={"k": 20})
...
with st.sidebar:
    ...
    queries the images databases BALaT of the IRPA (Royal Institute of Artistic Heritage), Belgica of the KBR (Royal Library) and Wikimedia Commons. At the \
    moment, about 2000 images are available.
    ...
    questionne les bases de données d'images BALaT de l'IRPA (Institut royal du Patrimoine artistique), Belgica de la KBR (Bibliothèque royale) et Wikimedia Commons. \
    Pour l'instant, environ 2000 images sont disponible.
