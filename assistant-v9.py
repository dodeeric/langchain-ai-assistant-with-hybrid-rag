...
def instanciate_retrievers_and_chains(_vector_db, model):
    ...
    if model == "OpenAI (1): gpt-4-turbo-2024-04-09" or "OpenAI (2): gpt-4o-2024-05-13":
        ...
        - At a new line, display an image of the artwork (see the "og:image" field). Do not display any images if an image of the artwork has been displayed already (see "Chat History").
